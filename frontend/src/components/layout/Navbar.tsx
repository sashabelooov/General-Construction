        ...
        <nav className="container-main">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-10 mx-auto">
              {navLinks.map((link) => (
                <button
                  ...
                  className={`nav-link text-sm font-medium ${location.pathname === link.href ? "text-accent" : ""
                    }`}
                >
                  {link.label}
                </button>
            ...
            <div className="hidden lg:flex items-center gap-6 ml-auto">
              ...
              <div className="flex items-center gap-5">
                {socialLinks.map((social) => (
                  social.href ? (
                    ...
                    <span
                      key={social.icon}
                      className="social-icon opacity-50 cursor-not-allowed"
                    >
                      {social.icon === "youtube" && (
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                          <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                    ...
                    >
                      {languages.map((lang) => (
                        <button
                          ...
                          className={`w-full px-4 py-2 text-left text-sm hover:bg-secondary transition-colors ${language === lang.code ? "bg-secondary text-accent" : ""
                            }`}
                        >
                          {lang.label}
                        </button>
              ...
              {/* Phone - without icon */}
              <a href="tel:+998785555544" className="font-medium text-sm">
                +998 (78) 555-55-44
              </a>
                    ...
                    {socialLinks.map((social) => (
                      social.href ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="social-icon p-2 bg-secondary rounded-full hover:bg-accent hover:text-primary transition-colors"
                        >
                          {social.icon === "telegram" && (
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 00-.05-.18c-.06-.05-.14-.03-.21-.02-.09.02-1.49.95-4.22 2.79-.4.27-.76.41-1.08.4-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 5.83-2.51 2.78-1.16 3.35-1.36 3.73-1.36.08 0 .27.02.39.12.1.08.13.19.14.27-.01.06.01.24 0 .37z" />
                        ...
                        <span
                          key={social.icon}
                          className="social-icon p-2 bg-secondary rounded-full opacity-50 cursor-not-allowed"
                        >
                          {social.icon === "youtube" && (
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                              <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
